...
if __name__ == '__main__':
    ...
    summary(model, input_size=[1,200,147],col_names=['num_params','kernel_size','mult_adds','input_size','output_size'],col_width=10,row_settings=['var_names'],depth=6,device = 'cpu')
