...
if __name__ == '__main__':
    ...
    model = fucontnet(args, 103, 9)
    model.eval()
    # # print(model)
    # output = model(input)
    # print('fucontnet', output.size())
    summary(model, input_data=torch.rand(1, 103, 256, 256),col_names=['num_params','kernel_size','mult_adds','input_size','output_size'],col_width=10,row_settings=['var_names'],depth=10,device='cpu')
