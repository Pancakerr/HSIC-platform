...
if __name__ == '__main__':
    ...
    model = UNet(3,16)
    model.eval()
    x=torch.randn(1,3,610,340)
    summary(model, input_data= x,col_names=['num_params','kernel_size','mult_adds','input_size','output_size'],col_width=15,row_settings=['var_names'],depth=6)
